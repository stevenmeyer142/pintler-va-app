...
import { HEALTHLAKE_DATASTORE_STATUS } from "../../amplify/data/resource"
  ...
  function DisplayPatient() {
   ...
   if (InitialId === undefined) {
    ...
    const healthLakeDatastore: HealthLakeDatastoreRecord =
    {
      ...
      name: 'test',
      datastore_id : null,
      status: HEALTHLAKE_DATASTORE_STATUS.INITIALIZED,
        ...
        <div>
          <div>
           ...
           <p><strong>Patient ICN:</strong> {patientId}</p>
            ...
            <p><button onClick={() => convertJsonToNdjson(patientBucket, patientJSONObjectKey, patientNDJSONObjectKey)}>Convert To NDJSON</button></p>
